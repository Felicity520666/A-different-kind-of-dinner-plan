...
define config.name = _("A different kind of dinner plan")
...
define build.name = "Adifferentkindofdinnerplan"
...
define config.save_directory = "Adifferentkindofdinnerplan-1763572663"
